...
export class FooterBasePage{
    ...
    constructor(page: Page) {
        ...
        this.footerShippingAndReturn = this.footer.locator('[href="/shipping-returns"]');
        this.footerPrivaryNotice = this.footer.locator('[href="/privacy-policy"]');
        this.footerConditionsOfUse = this.footer.locator('[href="/conditions-of-use"]');
        ...
        this.footerRecentlyViewedProducts = this.footer.locator('[href="/recentlyviewedproducts"]');
        this.footerCompareProductsList = this.footer.locator('[href="/compareproducts"]');
        this.footerNewProduct = this.footer.locator('[href="/newproducts"]');
        this.footerMyAccount = this.footer.locator('[href="/customer/info"]');
        this.footerOrder = this.footer.locator('[href="/order/history"]');
        ...
        this.footerFacebook = this.footer.locator('[href="http://www.facebook.com/nopCommerce"]');
        this.footerTwitter = this.footer.locator('[href="https://twitter.com/nopCommerce"]');
        this.footerRSS = this.footer.locator('[href="/news/rss/1"]');
        this.footerYouTube = this.footer.locator('[href="http://www.youtube.com/user/nopCommerce"]');
        this.footerGoogle = this.footer.locator('[href="https://plus.google.com/+nopcommerce"]');
    }
    async verifyFooterBasePage() {
